...
SELECT DISTINCT student.name, birthday, groupnumber FROM student INNER JOIN mark ON student.id = mark.student_id INNER JOIN subject ON mark.subject_id = subject.subject_id WHERE subject.name = 'Math';
